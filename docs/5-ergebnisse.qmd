...
![iSSF selection coefficients (β) with 95% confidence intervals for the seven retained covariates, ordered by effect size. All estimates are positive and exclude zero. The dashed line marks β = 0.](images/issf_coefficients-2.png){#fig-issf-coefficients}
